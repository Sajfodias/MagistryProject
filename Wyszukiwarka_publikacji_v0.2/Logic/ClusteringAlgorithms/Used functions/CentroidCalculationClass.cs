...
{
    public static class CentroidCalculationClass
    {
        ...
        public static List<Centroid> CentroidCalculationsForKMeansPP(List<DocumentVector> dataPP, int ClusterNumberPP)
        {
            ...
            while (centroidListPP.Count != ClusterNumberPP)
            {
                Centroid newCentroid = new Centroid();
                newCentroid.GroupedDocument = new List<DocumentVector>();
                newCentroid = Calculate_Next_Centroid(firstCentroid, dataPPCopy);
